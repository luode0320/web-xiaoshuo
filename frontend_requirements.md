...
- 冻结用户处理：被冻结用户登录后，界面会显示账户被冻结提示，上传、评论、评分等功能将被禁用，但仍可浏览和阅读已有内容
...
#### 1.5 上传页
- 上传功能：支持单个或批量上传txt、epub格式文件，普通用户每日上传限制为10本，管理员用户不受限制，超出限制时显示提示信息（使用vue-upload-component等第三方库实现），必须登录用户才能上传
