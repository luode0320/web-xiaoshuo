...
- 分类设置：用户阅读完小说后，可在最后一页为小说设置分类和关键词

### 2. 阅读功能
- 在线阅读：提供流畅的小说阅读体验
- 阅读进度：自动保存用户阅读进度到本地存储（使用第三方库实现）
- 书签功能：用户可添加和管理书签（使用第三方库实现）
...
- 评论弹窗（点击评论可打开评论列表弹窗，居中显示，可右上角关闭，支持滚动分页，点赞最多或最新评论在最前面）
- 相关推荐（推荐同类或同关键字的3本小说，向下滚动即可看到）
